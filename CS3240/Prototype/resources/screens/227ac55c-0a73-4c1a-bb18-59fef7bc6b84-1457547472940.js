jQuery("#simulation")
  .on("click", ".s-227ac55c-0a73-4c1a-bb18-59fef7bc6b84 .click", function(event, data) {
  ...
  .on("pageload", ".s-227ac55c-0a73-4c1a-bb18-59fef7bc6b84 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("windowscroll", ".s-227ac55c-0a73-4c1a-bb18-59fef7bc6b84 .windowscroll", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
